...
import be.artex.rolesffaold.item.Choose;
import be.artex.rolesffaold.role.DPS.*;
import be.artex.rolesffaold.role.DPS.muichiro.Muichiro;
import be.artex.rolesffaold.role.DPS.muichiro.SouffleBrume;
import be.artex.rolesffaold.role.technique.kyojuro.Purgatoire;
import be.artex.rolesffaold.role.technique.shoto.Shoto;
import be.artex.rolesffaold.role.technique.shoto.Fire;
import be.artex.rolesffaold.role.technique.shoto.Ice;
import be.artex.rolesffaold.role.tank.gyomei.Kusarigama;
import be.artex.rolesffaold.role.tank.ejiro.Unbreakable;
import be.artex.rolesffaold.role.DPS.obanai.Souffle;
import be.artex.rolesffaold.item.lame.Lame;
import be.artex.rolesffaold.role.technique.tomura.mains.Mains;
import be.artex.rolesffaold.role.technique.tomura.mains.Unusable;
import be.artex.rolesffaold.role.technique.tomura.Tomura;
import be.artex.rolesffaold.role.tank.ejiro.Ejiro;
import be.artex.rolesffaold.role.tank.gyomei.Gyomei;
import be.artex.rolesffaold.role.DPS.obanai.Obanai;
import be.artex.rolesffaold.role.technique.cupidon.Cupidon;
import be.artex.rolesffaold.listener.inventory.InventoryClick;
import be.artex.rolesffaold.listener.player.*;
import be.artex.rolesffaold.listener.player.EntityDamage;
import be.artex.rolesffaold.listener.player.PlayerItemDamage;
import be.artex.rolesffaold.listener.player.playerDamagePlayer.EntityHitEntity;
import org.bukkit.*;
